...
a,b = (1/num_samples)* np.ones(num_samples),(1/num_samples)*np.ones(num_samples)
...
max_iter = 3000
reg = 5 * 1e-3
res, acc, times, lam, alpha, beta, denom, KC, K_trans = EOT_sinkhorn.EOT_PSinkhorn(C,reg,a,b,max_iter=max_iter)
print(res)
...
max_iter = 3000
res, acc, times, lam, alpha, beta, denom, KC, K_trans = EOT_sinkhorn.EOT_APGD(C,reg,a,b,max_iter=max_iter)
print(res)
