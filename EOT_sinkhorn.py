...
def EOT_PGD(C,reg,a,b,max_iter=1000):
    ...
    grad_lam, grad_f, grad_g, denom, K_lam_trans, K_trans = compute_grad_EOT(lam,f,g,K,C,a,b,reg)
...
def EOT_APGD(C,reg,a,b,max_iter=1000):
    ...
    for k in range(max_iter):
        ...
        # Update f, g, lam
        grad_lam, grad_f, grad_g, denom_useless, K_lam_trans_useless, K_trans_useless = compute_grad_EOT(v,w,z,K,C,a,b,reg)
